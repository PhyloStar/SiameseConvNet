...
from keras.layers import merge, Dense, Dropout, Flatten, LSTM, Input, Lambda, Masking, Merge
...
#f = codecs.open("/home/taraka/list_length_project/sets/abvd2/output/abvd2.tsv.asjp","r", encoding="utf-8")
f.readline()
for line in f:
    line = line.strip()
    arr = line.split("\t")
